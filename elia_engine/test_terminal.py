...
async def test_terminal_service():
    ...
    try:
        ...
        create_response = await terminal_service.create_terminal(size_dict=size, session_id=session_id)
        ...
        await terminal_service.resize_terminal(size_dict=new_size, session_id=session_id)
        ...
        logger.error(f"Error during terminal testing: {str(e)}")
        raise
